...
In order to add custom parameters to nf-core pipeline you can create a new custom.config file. For instance you would like to add ```--alignEndsProtrude 100 ConcordantPair```  

```{bash, eval = F, chucnk.title}
